...
public class ReactivePanelContainer : global::Godot.PanelContainer, IActivatableView, IReactiveObject
{
...
public class ReactivePanelContainer<T> : ReactivePanelContainer, IViewFor<T> where T : class 
{
