...
public class ReactiveSplitContainer : global::Godot.SplitContainer, IActivatableView, IReactiveObject
{
...
public class ReactiveSplitContainer<T> : ReactiveSplitContainer, IViewFor<T> where T : class 
{
