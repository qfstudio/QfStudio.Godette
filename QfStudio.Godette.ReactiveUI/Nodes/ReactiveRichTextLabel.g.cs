...
public class ReactiveRichTextLabel : global::Godot.RichTextLabel, IActivatableView, IReactiveObject
{
...
public class ReactiveRichTextLabel<T> : ReactiveRichTextLabel, IViewFor<T> where T : class 
{
