...
public class ReactiveTextEdit : global::Godot.TextEdit, IActivatableView, IReactiveObject
{
...
public class ReactiveTextEdit<T> : ReactiveTextEdit, IViewFor<T> where T : class 
{
