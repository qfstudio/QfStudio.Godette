...
public class ReactiveNinePatchRect : global::Godot.NinePatchRect, IActivatableView, IReactiveObject
{
...
public class ReactiveNinePatchRect<T> : ReactiveNinePatchRect, IViewFor<T> where T : class 
{
