...
public class ReactiveGridContainer : global::Godot.GridContainer, IActivatableView, IReactiveObject
{
...
public class ReactiveGridContainer<T> : ReactiveGridContainer, IViewFor<T> where T : class 
{
