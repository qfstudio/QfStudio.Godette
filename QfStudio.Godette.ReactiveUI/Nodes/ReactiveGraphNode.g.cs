...
public class ReactiveGraphNode : global::Godot.GraphNode, IActivatableView, IReactiveObject
{
...
public class ReactiveGraphNode<T> : ReactiveGraphNode, IViewFor<T> where T : class 
{
