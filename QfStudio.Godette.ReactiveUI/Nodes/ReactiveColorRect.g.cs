...
public class ReactiveColorRect : global::Godot.ColorRect, IActivatableView, IReactiveObject
{
...
public class ReactiveColorRect<T> : ReactiveColorRect, IViewFor<T> where T : class 
{
