...
public class ReactiveContainer : global::Godot.Container, IActivatableView, IReactiveObject
{
...
public class ReactiveContainer<T> : ReactiveContainer, IViewFor<T> where T : class 
{
