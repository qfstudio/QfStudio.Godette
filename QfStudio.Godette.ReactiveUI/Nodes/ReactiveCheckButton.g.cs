...
public class ReactiveCheckButton : global::Godot.CheckButton, IActivatableView, IReactiveObject
{
...
public class ReactiveCheckButton<T> : ReactiveCheckButton, IViewFor<T> where T : class 
{
