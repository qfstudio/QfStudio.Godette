...
public class ReactiveTextureRect : global::Godot.TextureRect, IActivatableView, IReactiveObject
{
...
public class ReactiveTextureRect<T> : ReactiveTextureRect, IViewFor<T> where T : class 
{
