...
public class ReactiveHSplitContainer : global::Godot.HSplitContainer, IActivatableView, IReactiveObject
{
	...
	public ReactiveHSplitContainer()
	{
...
public class ReactiveHSplitContainer<T> : ReactiveHSplitContainer, IViewFor<T> where T : class 
{
