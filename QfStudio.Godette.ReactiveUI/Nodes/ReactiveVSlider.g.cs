...
public class ReactiveVSlider : global::Godot.VSlider, IActivatableView, IReactiveObject
{
...
public class ReactiveVSlider<T> : ReactiveVSlider, IViewFor<T> where T : class 
{
