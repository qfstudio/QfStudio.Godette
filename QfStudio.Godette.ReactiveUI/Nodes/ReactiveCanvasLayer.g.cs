...
public class ReactiveCanvasLayer : global::Godot.CanvasLayer, IActivatableView, IReactiveObject
{
...
public class ReactiveCanvasLayer<T> : ReactiveCanvasLayer, IViewFor<T> where T : class 
{
