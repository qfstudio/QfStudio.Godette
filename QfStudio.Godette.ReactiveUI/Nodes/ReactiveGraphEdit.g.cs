...
public class ReactiveGraphEdit : global::Godot.GraphEdit, IActivatableView, IReactiveObject
{
...
public class ReactiveGraphEdit<T> : ReactiveGraphEdit, IViewFor<T> where T : class 
{
