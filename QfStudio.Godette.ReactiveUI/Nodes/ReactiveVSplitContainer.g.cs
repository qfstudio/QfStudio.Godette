...
public class ReactiveVSplitContainer : global::Godot.VSplitContainer, IActivatableView, IReactiveObject
{
	...
	public ReactiveVSplitContainer()
	{
...
public class ReactiveVSplitContainer<T> : ReactiveVSplitContainer, IViewFor<T> where T : class 
{
