...
public class ReactiveBoxContainer : global::Godot.BoxContainer, IActivatableView, IReactiveObject
{
...
public class ReactiveBoxContainer<T> : ReactiveBoxContainer, IViewFor<T> where T : class 
{
