...
public class ReactiveVBoxContainer : global::Godot.VBoxContainer, IActivatableView, IReactiveObject
{
...
public class ReactiveVBoxContainer<T> : ReactiveVBoxContainer, IViewFor<T> where T : class 
{
