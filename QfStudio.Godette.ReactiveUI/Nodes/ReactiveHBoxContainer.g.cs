...
public class ReactiveHBoxContainer : global::Godot.HBoxContainer, IActivatableView, IReactiveObject
{
...
public class ReactiveHBoxContainer<T> : ReactiveHBoxContainer, IViewFor<T> where T : class 
{
